...
import { BUILDER_POTION_ADDRESSES } from "../cons/address";

const CardBP = () => {

    const address = useAddress();
    const { contract: tokenContract } = useContract(BUILDER_POTION_ADDRESSES);
    ...
    return(
        ...
        <div className='lg:col-span-2 col-span-1 bg-[#242323] flex justify-between w-full border p-4 rounded-lg'>
            <div className='flex flex-col w-full pb-4'>
                ...
                <p className='text-white'>Builder Potion</p>
            </div>
